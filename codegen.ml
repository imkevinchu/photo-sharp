...
let translate (globals, functions) =
  ...
  let printhello_t : L.lltype =
      L.function_type i32_t [| i32_t |] in
  let printhello_func : L.llvalue =
      L.declare_function "printhello" printhello_t the_module in
  ...
  let build_function_body fdecl =
    ...
    let rec expr builder ((_, e) : sexpr) = match e with
      ...
      | SCall ("printhello", [e]) ->
    L.build_call printhello_func [| (expr builder e) |] "printhello" builder
      | SCall ("printf", [e]) ->
